        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="/SWP391_Group6/admin/coursemanage">Danh sách khóa học</a></li>
                </ul>
            </div>
            <div class="container-fluid al">
                <div id="clock"></div>
                <Br>
                <p class="quanlyphanhoi"><b>QUẢN LÝ BÀI HỌC:</b></p><Br><Br>
                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.lessons}" var="less">
                            <tr>
                                <th width="auto">${less.lesson_id}</th>
                                <th width="auto">${less.lesson_name}</th>
                                <th width="auto">${less.lesson_description}</th>
                                <td class="table-td-center">
                                    <form action="/SWP391_Group6/admin/deletelesson" method="POST">
                                        <input type="submit" class="btn btn-primary btn-sm trash" value="Xóa">
                                        <input type="hidden" value="${less.lesson_id}" name="lessID">
                                        <input type="hidden" value="${requestScope.couID}" name="course_id">
                                    </form>                                                                 
                                </td>
                            </tr>
                        </c:forEach>
